<?php
  ...
  $contentBlock = get_sub_field('plain_text_block');
  ...
  <div <?php echo $blockID; ?> class="content-block plain-text <?php echo $blockClass . $blockWidth . $blockAlign . $centerContent; ?>">
